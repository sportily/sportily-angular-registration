angular.module('sportily-registration', ['templates/registration.html']);
...
angular.module("templates/registration.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("templates/registration.html",
    ...
    "        <input type=\"text\" class=\"form-control form-control-xs\" id=\"date_of_birth\" ng-model=\"person.date_of_birth\" placeholder=\"dd/mm/yyyy\"/>\n" +
    "    </div>\n" +
    "\n" +
    "    <h2>League Roles</h2>\n" +
    "\n" +
    ...
    "                <span>for &nbsp;</span>\n" +
    "                <select class=\"form-control\"\n" +
    "                    ng-options=\"team.id as team.name + ' (' + ageGroups[team.age_group_id] + ')' for team in teams|filter:{organisation_id:role.organisation_id}\"\n" +
    "                    ng-model=\"role.team_id\">\n" +
    "                    <option value=\"\">Team&hellip;</option>\n" +
    "                </select>\n" +
    "            </div>\n" +
    "\n" +
    "            <a ng-click=\"addRole()\" ng-if=\"$last && role.organisation_id && role.type\">More roles&hellip;</a>\n" +
    "\n" +
    "        </div>\n" +
    "    </div>\n" +
    "\n" +
